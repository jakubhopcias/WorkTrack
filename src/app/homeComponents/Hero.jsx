...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-[100dvh] flex justify-center items-center w-full overflow-clip px-2">
      <img alt="" src="/Projekt.png" className="border-[var(--color-primary-1-lighter)] border-2 opacity-45 w-[650px] -right-[15vw] rounded-2xl top-[25%] absolute -tranlate-y-1/2" />
      <img alt="" src="/Projekty.png" className="border-[var(--color-primary-1-lighter)] border-2 opacity-45 w-[650px] -left-[15vw] rounded-2xl top-[15%] absolute -tranlate-y-1/2" />
